 ...
 */
@Component
public class EmailProducer implements KafkaProducer {
    ...
    @Autowired
    public EmailProducer(KafkaTemplate<String, String> orderProducer, OrderConfigurationService orderConfigurationService,
    ...
    public void send(Object object) {
        String orderTransferTopic = orderConfigurationService.getKafkaEmailTransferTopic();
